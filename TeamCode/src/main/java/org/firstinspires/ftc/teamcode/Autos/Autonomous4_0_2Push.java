...
//        out.reset();
        ...
        Pose2d highChamberPose = new Pose2d(highChamberXPose, -32.5, Math.toRadians(270));
        Pose2d highChamberPose2 = new Pose2d(-15, -25.5, Math.toRadians(270));
        Pose2d highChamberPose3 = new Pose2d(-2, -22, Math.toRadians(270));
        Pose2d highChamberPose4 = new Pose2d(0, -20, Math.toRadians(270));
        Pose2d sample1Pose = new Pose2d(48, -3, Math.toRadians(270));
        Pose2d sample1PushPose = new Pose2d(48, -47, Math.toRadians(270));
        double sample2Xpose = 57.5; // this should always be the same as sample 2 X pose
        Pose2d sample2Pose = new Pose2d(sample2Xpose, -8, Math.toRadians(90));
        ...
        Pose2d obsZonePoseforinside = new Pose2d(42, -40, Math.toRadians(90));
        Pose2d obsZonePikcupPoseforinside = new Pose2d(42, -57, Math.toRadians(90));
