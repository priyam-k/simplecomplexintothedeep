...
public class Red1_3SampleFaster extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action basket2Action = new SequentialAction(basket2traj, new SleepAction(0.5), basketActions);
        Action sample2Action = new SequentialAction(sample2traj, new SleepAction(0.5), pickupActions);
        Action basket3Action = new SequentialAction(basket3traj, new SleepAction(0.5), basketActions);
        Action sample3Action = new SequentialAction(sample3traj, new SleepAction(0.5), pickupActions);
        Action basket4Action = new SequentialAction(basket4traj, new SleepAction(0.5), basketActions);
