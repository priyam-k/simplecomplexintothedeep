...
@Autonomous(name = "A: Krunkle Red 1+3 Sample")
public class Red1_3SampleKrunklefeild extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d basketPose2 = new Pose2d(-57, -52.5, Math.toRadians(45));
        Pose2d basketPose3 = new Pose2d(-56-3, -53-3, Math.toRadians(45));
        Pose2d samplePose1 = new Pose2d(-53.6, -45.5, Math.toRadians(95));
        Pose2d samplePose2 = new Pose2d(-68.5, -47, Math.toRadians(95));
