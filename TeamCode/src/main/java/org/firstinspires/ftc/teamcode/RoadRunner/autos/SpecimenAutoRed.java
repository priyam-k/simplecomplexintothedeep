...
@Autonomous(name = "A Specimen Auto Red")
public class SpecimenAutoRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive = new MecanumDrive(hardwareMap, new Pose2d(0, -35, Math.toRadians(270)));
        ...
        Action obsZoneTraj = drive.actionBuilder(drive.pose)
                ...
                .build();
        drive = new MecanumDrive(hardwareMap, new Pose2d(47, 59, Math.toRadians(90)));
