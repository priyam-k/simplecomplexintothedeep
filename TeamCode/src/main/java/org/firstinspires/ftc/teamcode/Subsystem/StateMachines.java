...
public class StateMachines {
    ...
    public static StateMachine getOuttakeStateMachine(MiggyUnLimbetedOuttake out, Gamepad gamepad, StateMachine intake, Telemetry telemetry) {
        return new StateMachineBuilder()
                ...
                .onEnter(() -> out.specimenSlideUp(gamepad, telemetry))
