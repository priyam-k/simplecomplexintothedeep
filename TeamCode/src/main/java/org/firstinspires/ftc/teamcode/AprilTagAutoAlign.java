...
public class AprilTagAutoAlign extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action sample1Traj = drive3.actionBuilder(drive3.pose)
                .splineToLinearHeading(new Pose2d(51.8, 43.5, Math.toRadians(-95)), Math.toRadians(-90)) //56.5, 54
                .build();
        drive3 = new MecanumDrive(hardwareMap, new Pose2d(51.8, 43.5, Math.toRadians(-95)));
        ...
        Action sample2Traj = drive3.actionBuilder(drive3.pose)
                .splineToLinearHeading(new Pose2d(69, 43.5, Math.toRadians(-95)), Math.toRadians(-90))
                .build();
