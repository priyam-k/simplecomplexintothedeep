...
public class AprilTagAutoAlign extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action sample1Traj = drive3.actionBuilder(drive3.pose)
                .splineToLinearHeading(new Pose2d(53, 43.5, Math.toRadians(-95)), Math.toRadians(-90)) //56.5, 54
                .build();
        drive3 = new MecanumDrive(hardwareMap, new Pose2d(53, 43.5, Math.toRadians(-95)));
        Action basketTraj = drive3.actionBuilder(drive3.pose)
                .splineToLinearHeading(new Pose2d(58.5, 51.5, Math.toRadians(230)), Math.toRadians(100)) //56.5, 54
                .build();
