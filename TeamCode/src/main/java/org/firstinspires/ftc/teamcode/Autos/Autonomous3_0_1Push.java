...
@Config
@Autonomous(name = "A FREEZE: 3+0 park")
public class Autonomous3_0_1Push extends LinearOpMode {
...
//        out.reset();
        ...
        Pose2d highChamberPose3 = new Pose2d(0, -15, Math.toRadians(270));
        Pose2d sample1Pose = new Pose2d(48, 0, Math.toRadians(270));
        Pose2d sample1PushPose = new Pose2d(50, -40, Math.toRadians(270));
        Pose2d obsZonePose = new Pose2d(48, -30, Math.toRadians(90));
        Pose2d obsZonePickupPose = new Pose2d(47, -50, Math.toRadians(90));
        Pose2d obsZonePickupPose2 = new Pose2d(47, -48, Math.toRadians(90));
        Pose2d parkPose = new Pose2d(47, -50, Math.toRadians(270));
        ...
        Action highChamberTraj3 = mecanumDrive.actionBuilder(mecanumDrive.pose).setTangent(Math.toRadians(90)).splineToLinearHeading(highChamberPose3, Math.toRadians(90)).build();
