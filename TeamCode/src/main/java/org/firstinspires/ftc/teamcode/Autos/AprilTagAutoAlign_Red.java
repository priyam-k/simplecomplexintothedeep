...
@Config
@Autonomous(name = " RED April Tag Auto Align")
public class AprilTagAutoAlign_Red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive3 = new MecanumDrive(hardwareMap, new Pose2d(0, 45, Math.toRadians(175)));
        Action sample1Traj = drive3.actionBuilder(drive3.pose)
                ...
                .build();
        drive3 = new MecanumDrive(hardwareMap, new Pose2d(-51.8, -43, Math.toRadians(85)));
        Action basketTraj = drive3.actionBuilder(drive3.pose)
                ...
                .build();
        drive3 = new MecanumDrive(hardwareMap, new Pose2d(-61, -47.5, Math.toRadians(40)));
